...
void _userModelSerialize(
  ...
  writer.writeLong(offsets[2], object.facultyProfileId);
  ...
  writer.writeLong(offsets[7], object.studentProfileId);
}
...
UserModel _userModelDeserialize(
  ...
  object.facultyProfileId = reader.readLongOrNull(offsets[2]);
  object.id = id;
  ...
  object.role = _UserModelroleValueEnumMap[reader.readByteOrNull(offsets[6])] ??
      UserRole.student;
  object.studentProfileId = reader.readLongOrNull(offsets[7]);
  return object;
}
...
extension UserModelQuerySortBy on QueryBuilder<UserModel, UserModel, QSortBy> {
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> sortByFacultyProfileId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> sortByStudentProfileId() {
    return QueryBuilder.apply(this, (query) {
...
extension UserModelQuerySortThenBy
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByFacultyProfileId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'facultyProfileId', Sort.asc);
    });
  }
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByStudentProfileId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'studentProfileId', Sort.asc);
    });
  }
...
extension UserModelQueryWhereDistinct
  ...
  QueryBuilder<UserModel, UserModel, QDistinct> distinctByFacultyProfileId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QDistinct> distinctByStudentProfileId() {
    return QueryBuilder.apply(this, (query) {
...
extension UserModelQueryProperty
  ...
  QueryBuilder<UserModel, int?, QQueryOperations> facultyProfileIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, int?, QQueryOperations> studentProfileIdProperty() {
    return QueryBuilder.apply(this, (query) {
