...
extension DepartmentModelByIndex on IsarCollection<DepartmentModel> {
  Future<DepartmentModel?> getByCode(String code) {
    return getByIndex(r'code', [code]);
  }

  DepartmentModel? getByCodeSync(String code) {
  ...
  Future<List<DepartmentModel?>> getAllByCode(List<String> codeValues) {
    final values = codeValues.map((e) => [e]).toList();
    return getAllByIndex(r'code', values);
  }

  List<DepartmentModel?> getAllByCodeSync(List<String> codeValues) {
    final values = codeValues.map((e) => [e]).toList();
  ...
  Future<Id> putByCode(DepartmentModel object) {
    return putByIndex(r'code', object);
  }

  Id putByCodeSync(DepartmentModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'code', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByCode(List<DepartmentModel> objects) {
    return putAllByIndex(r'code', objects);
  }

  List<Id> putAllByCodeSync(List<DepartmentModel> objects,
      {bool saveLinks = true}) {
...
extension DepartmentModelQueryWhere
  ...
  QueryBuilder<DepartmentModel, DepartmentModel, QAfterWhereClause> codeEqualTo(
      String code) {
    return QueryBuilder.apply(this, (query) {
...
extension DepartmentModelQuerySortBy
  ...
  QueryBuilder<DepartmentModel, DepartmentModel, QAfterSortBy> sortByCode() {
    return QueryBuilder.apply(this, (query) {
...
extension DepartmentModelQuerySortThenBy
  ...
  QueryBuilder<DepartmentModel, DepartmentModel, QAfterSortBy> thenByCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'code', Sort.asc);
    });
  }
...
extension DepartmentModelQueryWhereDistinct
  ...
  QueryBuilder<DepartmentModel, DepartmentModel, QDistinct> distinctByCode(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DepartmentModel, DepartmentModel, QDistinct> distinctByFullName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension DepartmentModelQueryProperty
  ...
  QueryBuilder<DepartmentModel, String, QQueryOperations> codeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'code');
    });
  }

  QueryBuilder<DepartmentModel, String, QQueryOperations> fullNameProperty() {
    return QueryBuilder.apply(this, (query) {
