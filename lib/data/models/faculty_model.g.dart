...
const FacultyModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'subjectsTaught': PropertySchema(
      id: 2,
      name: r'subjectsTaught',
...
int _facultyModelEstimateSize(
  ...
  bytesCount += 3 + object.subjectsTaught.length * 3;
  {
    for (var i = 0; i < object.subjectsTaught.length; i++) {
      final value = object.subjectsTaught[i];
...
void _facultyModelSerialize(
  ...
  writer.writeStringList(offsets[2], object.subjectsTaught);
...
FacultyModel _facultyModelDeserialize(
  ...
  object.id = id;
  object.subjectsTaught = reader.readStringList(offsets[2]) ?? [];
...
extension FacultyModelQueryFilter
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterFilterCondition>
      subjectsTaughtElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'subjectsTaught',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterFilterCondition>
      subjectsTaughtElementGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterFilterCondition>
      subjectsTaughtElementStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterFilterCondition>
      subjectsTaughtElementContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'subjectsTaught',
        value: value,
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterFilterCondition>
      subjectsTaughtElementMatches(String pattern,
          {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'subjectsTaught',
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterFilterCondition>
      subjectsTaughtElementIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'subjectsTaught',
        value: '',
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterFilterCondition>
      subjectsTaughtLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterFilterCondition>
      subjectsTaughtLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterFilterCondition> userIdEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'userId',
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterFilterCondition> userIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension FacultyModelQuerySortBy
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterSortBy> sortByDepartment() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterSortBy> sortByDesignation() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterSortBy> sortByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.asc);
    });
  }

  QueryBuilder<FacultyModel, FacultyModel, QAfterSortBy> sortByUserIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension FacultyModelQuerySortThenBy
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterSortBy> thenByDepartment() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'department', Sort.asc);
    });
  }
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterSortBy> thenByDesignation() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'designation', Sort.asc);
    });
  }
  ...
  QueryBuilder<FacultyModel, FacultyModel, QAfterSortBy> thenByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.asc);
    });
  }

  QueryBuilder<FacultyModel, FacultyModel, QAfterSortBy> thenByUserIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.desc);
    });
  }
...
extension FacultyModelQueryWhereDistinct
  ...
  QueryBuilder<FacultyModel, FacultyModel, QDistinct> distinctByDepartment(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FacultyModel, FacultyModel, QDistinct> distinctByDesignation(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FacultyModel, FacultyModel, QDistinct>
      distinctBySubjectsTaught() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'subjectsTaught');
    });
  }

  QueryBuilder<FacultyModel, FacultyModel, QDistinct> distinctByUserId() {
    return QueryBuilder.apply(this, (query) {
...
extension FacultyModelQueryProperty
  ...
  QueryBuilder<FacultyModel, String, QQueryOperations> departmentProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'department');
    });
  }

  QueryBuilder<FacultyModel, String, QQueryOperations> designationProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'designation');
    });
  }

  QueryBuilder<FacultyModel, List<String>, QQueryOperations>
      subjectsTaughtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'subjectsTaught');
    });
  }

  QueryBuilder<FacultyModel, int, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
